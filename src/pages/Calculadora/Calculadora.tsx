          ...
          <section className="flex flex-col-reverse lg:flex-row gap-8">
            <div className="lg:w-1/2 bg-white rounded-2xl shadow-md p-8">
              ...
              <p className="text-gray-600 mb-6 text-base">
                Adicione, edite e exclua operações para obter cálculos
                automáticos de Preço Médio, Quantidade Média, Prejuízo Acumulado
                e Imposto Devido.
              </p>
              <OperationsTable
            ...
            <div className="lg:w-1/2 bg-white rounded-2xl shadow-md p-8 flex flex-col justify-center">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Nossa tabela foi projetada para oferecer controle total sobre
                cada compra e venda de ações. Insira nome, data, tipo
                (Compra/Venda), preço, quantidade e taxa, e veja os resultados
                imediatamente atualizados na própria tabela e no gráfico.
                Monitore seu preço médio, prejuízos acumulados e imposto devido
                em tempo real, de forma clara e precisa.
              </p>
              ...
              <p className="text-gray-700 mt-6 text-base italic">
                ...
                tomar decisões com mais segurança — tudo em uma interface limpa
                e direta.
              </p>
            </div>
          </section>
          ...
          <section className="flex flex-col lg:flex-row gap-8">
            <div className="lg:w-1/2 bg-white rounded-2xl shadow-md p-8 flex flex-col justify-center">
              ...
              <ul className="list-decimal list-inside space-y-2 text-gray-600 text-base">
                <li>
                  Clique nos pontos coloridos do gráfico para dar <em>zoom</em>{" "}
                  e focar no intervalo selecionado.
                </li>
                <li>
